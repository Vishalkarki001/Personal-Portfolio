...
export default function Home() {
   ...
   <div className='flex flex-col md:flex-row '>
      ...
      <div className='flex flex-col max-[768px]:items-center space-x-1'>
        ...
        <h3 className=' bg-orange-500 p-2 rounded-full font-sans text-md px-4'><a href="C:\Users\Vishal karki\Desktop\React pro\Portfolio\VISHAL KARKI.docx" download> Download cv</a></h3>
        </div>
        </div>
        ...
        <img  src="C:\Users\Vishal karki\Desktop\React pro\Portfolio\pic.jpg" className='rounded-full md:h-[430px] md:w-[430px] ' alt='image'/>
